      ...
      <aside class="fixed inset-y-0 z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0 min-h-screen">
        <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <li class="relative px-6 py-3">
                ...
                @class([
                    'inline-flex items-center w-full text-sm font-semibold transition-colors duration-150',
                    'text-gray-800 dark:text-gray-100' => request()->routeIs('cards'),
                    'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' => !request()->routeIs('cards'),
                ])>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="relative px-6 py-3">
                ...
                @class([
                    'inline-flex items-center w-full text-sm font-semibold transition-colors duration-150',
                    'text-gray-800 dark:text-gray-100' => request()->routeIs('charts'),
                    'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' => !request()->routeIs('charts'),
                ])>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Buttons -->
            <li class="relative px-6 py-3">
                @if(request()->routeIs('buttons'))
                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                @endif
                <a href="{{ route('buttons') }}"
                @class([
                    'inline-flex items-center w-full text-sm font-semibold transition-colors duration-150',
                    'text-gray-800 dark:text-gray-100' => request()->routeIs('buttons'),
                    'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' => !request()->routeIs('buttons'),
                ])>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="relative px-6 py-3">
                ...
                @class([
                    'inline-flex items-center w-full text-sm font-semibold transition-colors duration-150',
                    'text-gray-800 dark:text-gray-100' => request()->routeIs('modals'),
                    'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' => !request()->routeIs('modals'),
                ])>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Tables -->
            <li class="relative px-6 py-3">
                @if(request()->routeIs('tables'))
                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                @endif
                <a href="{{ route('tables') }}"
                @class([
                    'inline-flex items-center w-full text-sm font-semibold transition-colors duration-150',
                    'text-gray-800 dark:text-gray-100' => request()->routeIs('tables'),
                    'text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' => !request()->routeIs('tables'),
                ])>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
